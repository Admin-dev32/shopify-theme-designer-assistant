...
Downloaded: 2026-06-30T03:56:11.790Z

---

Liquid reference Skip to main content Collapse sidebar Liquid reference
 ...
 Anchor to Variations of Liquid Variations of Liquid 
 ...
 Notification templates Notification templates Notification templates Shopify Flow Shopify Flow Shopify Flow Order printer templates Order printer templates Order printer templates Packing slip templates Packing slip templates Packing slip templates 
 
 Anchor to Liquid basics Liquid basics 
 ...
 Navigate to Basics Navigate to Basics Navigate to - Basics 9 1 2 3 4 5 6 < title > {{ page_title }} </ title > {% if page_description -%} < meta name = "description" content = " {{ page_description | truncate : 150 }} " > {%- endif %} Code <title>
 {{ page_title }}
</title>
{% if page_description -%}
...
{%- endif %}
 ...
 Output
 9 1 2 3 4 < title > Health potion </ title > < meta name = "description" content = "Are you low on health? Well we've got the potion just for you! Just need a top up? Almost dead? In between? No need to worry because we have a ..." > Output <title>
 Health potion
</title>
<meta name="description" content="Are you low on health? Well we&#x27;ve got the potion just for you! Just need a top up? Almost dead? In between? No need to worry because we have a ...">
 ...
 Anchor to Defining logic with tags Defining logic with tags 
...
Otherwise, the “sold out” message is shown.
 ...
 tag.
 9 1 2 3 4 5 {% if product . available %} Price: $99.99 {% else %} Sorry, this product is sold out. {% endif %} Code {% if product.available %}
 Price: $99.99
{% else %}
...
{% endif %}
 ...
 Output
 9 1 Price: $99.99 Output Price: $99.99

 Anchor to Tags with parameters Tags with parameters 
...
For example, the for
 ...
 9 1 2 3 4 5 {% assign numbers = '1,2,3,4,5' | split : ',' %} {% for item in numbers limit : 2 -%} {{ item }} {% endfor %} Code {% assign numbers = &#x27;1,2,3,4,5&#x27; | split: &#x27;,&#x27; %}
...
2
 ...
 Anchor to Modifying output with filters Modifying output with filters 
...
In this example, product
 ...
 is the filter.
 9 1 2 3 {% # product.title -> Health potion %} {{ product . title | upcase }} Code {% # product.title -> Health potion %}
...
{{ product.title | upcase }}
 ...
 Output
 9 1 HEALTH POTION Output HEALTH POTION

 Anchor to Filters with parameters Filters with parameters 
 Many filters accept parameters that adjust their output.
Some parameters are required, others are optional.
 9 1 2 3 {% # product.title -> Health potion %} {{ product . title | remove : 'Health' }} Code {% # product.title -> Health potion %}
...
{{ product.title | remove: &#x27;Health&#x27; }}
 ...
 Output
 9 1 potion Output potion

 Anchor to Using multiple filters Using multiple filters 
 Multiple filters can be used on one output. They&#x27;re applied from left to right.
 9 1 2 3 {% # product.title -> Health potion %} {{ product . title | upcase | remove : 'HEALTH' }} Code {% # product.title -> Health potion %}
...
{{ product.title | upcase | remove: &#x27;HEALTH&#x27; }}
 ...
 Anchor to Referencing objects Referencing objects 
 ...
 Functional elements that can be used to build interactivity, such as paginate
 and search
...
This example outputs the product
 object&#x27;s title
 property.
 9 1 {{ product . title }} Code {{ product.title }}
 ...
 Anchor to Object access Object access 
 ...
 In templates : Available in specific templates and their sections or blocks. For example, the product
 object in a product template 

 Through parent objects : Returned as properties of other objects. For example, article
 objects through articles
 or blog

 Check each object&#x27;s documentation to see how it can be accessed.
 Anchor to Creating variables Creating variables 
 To create your own variables, use variable tags like assign
 or capture
 .
Syntactically, Liquid treats variables the same as objects.
 9 1 2 {% assign my_variable = 'My custom string.' %} {{ my_variable }} Code {% assign my_variable = &#x27;My custom string.&#x27; %}
{{ my_variable }}

 Output
 9 1 My custom string. Output My custom string.

 Anchor to Resources & tools Resources & tools 
 Liquid Cheat Sheet A simple reference guide to the Liquid language.
 Liquid Cheat Sheet A simple reference guide to the Liquid language.
 Liquid Cheat Sheet A simple reference guide to the Liquid language.
 Theme Check Command line-based linter for themes. Also comes as an official Visual Studio Code extension.
 Theme Check Command line-based linter for themes. Also comes as an official Visual Studio Code extension.
 Theme Check Command line-based linter for themes. Also comes as an official Visual Studio Code extension.
 Shopify CLI for Themes A powerful command-line tool for building Shopify themes, and exploring Liquid code in a REPL interface.
 Shopify CLI for Themes A powerful command-line tool for building Shopify themes, and exploring Liquid code in a REPL interface.
 Shopify CLI for Themes A powerful command-line tool for building Shopify themes, and exploring Liquid code in a REPL interface.
 Open source liquid Liquid is an open source project on GitHub.
 Open source liquid Liquid is an open source project on GitHub.
 Open source liquid Liquid is an open source project on GitHub.
