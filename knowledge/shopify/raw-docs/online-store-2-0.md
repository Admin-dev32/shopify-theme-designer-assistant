...
Downloaded: 2026-06-30T03:56:03.166Z

---

Online Store 2.0 Skip to main content Collapse sidebar 
 ...
 Anchor to Added functionality and support Added functionality and support 
 ...
 Note: These features were announced at Shopify Unite 2021. Watch the full Shopify Unite 2021 stream .
 Anchor to Sections on every page Sections on every page 
 ...
 Anchor to Dynamic sources Dynamic sources 
 ...
 Anchor to App blocks App blocks 
 ...
 Anchor to Migrating to Online Store 2.0 Migrating to Online Store 2. 
 ...
 Migration assessment Identify the best Online Store 2.0 migration path for a business.
 Migration assessment Identify the best Online Store 2.0 migration path for a business.
 Migration assessment Identify the best Online Store 2.0 migration path for a business.
 Migration guide Learn how to migrate a template to add support for Online Store 2.0 features.
 Migration guide Learn how to migrate a template to add support for Online Store 2.0 features.
 Migration guide Learn how to migrate a template to add support for Online Store 2.0 features.
